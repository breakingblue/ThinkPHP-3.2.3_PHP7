...
defined('LANG_PATH')    or define('LANG_PATH',      COMMON_PATH.'Lang/');    // 应用预言目录
defined('HTML_PATH')    or define('HTML_PATH',      APP_PATH.'Html/');  // 应用静态目录
defined('LOG_PATH')     or define('LOG_PATH',       RUNTIME_PATH.'Temp/');  // 应用缓存目录
defined('DATA_PATH')    or define('DATA_PATH',      RUNTIME_PATH.'Cache/'); // 应用模板缓存目录
